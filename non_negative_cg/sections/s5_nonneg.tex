...
\begin{proof}
Write $r = b_{\mathcal{F}} - A_{\mathcal{F}}\tilde x_{\mathcal{F}}$, so
$\tilde x_{\mathcal{F}} - \hat x_{\mathcal{F}} = -A_{\mathcal{F}}^{-1} r$. Cauchy interlacing
gives $\lambda_{\min}(A_{\mathcal{F}}) \ge \lambda_{\min}(A)$, hence
\[
...
Fix $i \in \mathcal{F}$. If $\hat x_i \ge 0$ then $\hat x_i = 0$ or $\hat x_i \ge \mu$; either
