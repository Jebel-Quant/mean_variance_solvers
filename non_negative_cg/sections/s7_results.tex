...
directly from their definitions; the external-solver benchmark below is a second script whose
only additional dependencies are SciPy and Clarabel. The algorithms are also released as the
...
under inexact solves, the warm-start single-step property, and the adversarial family that
