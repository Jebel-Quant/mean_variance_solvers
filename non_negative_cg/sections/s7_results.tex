...
\emph{Warm-starting along the efficient frontier.} The parametric sweep a practitioner
...
free-set solve. MPRGP does not enter this comparison: the budget $\mathbf{1}^\top w = 1$ is an
equality constraint outside its bound-only scope.
...
\emph{Matrix-free at portfolio scale.} Because the factor operator is never assembled, the
