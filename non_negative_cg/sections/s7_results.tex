...
\subsubsection{Deblurring beyond a dense operator}
...
\subsubsection{Timing against dense baselines}

The same family places the method against four external
...
\subsection{Preconditioning}\label{ssec:precond_results}

\subsubsection{Jacobi preconditioning}

Section~\ref{sec:conditioning}'s claim that a preconditioner slots
...
\subsubsection{Preconditioner reuse: \texttt{Nystrom} versus \texttt{GlobalNystrom}}
...
\subsubsection{A planted benchmark}

The comparisons so far are internal: active-set variants against
...
\subsubsection{A real, non-synthetic check}

\textcolor{blue}{
The external-baseline comparison above is on a planted
