...
preconditioner that costs one vector division per iteration. A more powerful
low-rank-plus-diagonal (randomized Nyström) preconditioner, and the economics of sketching the
operator once versus resketching each free block, are developed and timed in
Appendix~\ref{app:nystrom}.
