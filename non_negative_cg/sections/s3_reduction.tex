...
CG needs only the mat-vec $v \mapsto A_{\mathcal{F}}\,v$, never the explicit matrix. For
...
$O(\sqrt\kappa\,\log\varepsilon^{-1})$ iterations, and clustered spectra do better---the
...
dependence is the whole reason to keep a Krylov inner solver: the projected-gradient reference
