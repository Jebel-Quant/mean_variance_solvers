...
Section~\ref{sec:reduction}---a strictly larger problem class than the bound-constrained one the
feasible-point family addresses. Termination is combinatorial: it rests on Murty's least-index rule, which is what
