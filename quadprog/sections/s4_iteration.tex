...
additions and removals --- the trajectory is unchanged, not merely its first step
--- and returns a minimiser agreeing to $3.3\times10^{-16}$.
\end{remark}
...
are recomputed --- both change, because $J$ and $R$ have --- keeping the same
