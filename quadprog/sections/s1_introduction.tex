...
package implements it,\footnote{\url{https://github.com/Jebel-Quant/quadprog}}
together with the two extensions that package adds. It is written because the
companion paper accompanying the package is about something else. That paper asks
...
identity the solver depends on, derived, with the degenerate cases named.
