...
passes, each positive by Proposition~\ref{prop:increment} --- the accumulated $u_*$
and each step $t$ share a sign throughout, by Remark~\ref{rem:reverse} --- and the
...
implementation tests --- neither step limit finite --- is literally the hypothesis
