...
Every number in this note is produced by a committed script, and no figure or
table was edited by hand. The scripts write the files the note \verb|\input|s, so
...
script writes no figure, and the sweep script writes one the note does not
...
\paragraph{Regenerating everything.} From this note's source tree, \verb|make figures|
...
to the last digit or two of rounding, and are what the note rests on.
