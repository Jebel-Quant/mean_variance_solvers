...
generalisation, because the reason is structural, not a gap in the
argument.
...
the pivot is undefined, not just awkward. There is no $P$-matrix to
...
optimal, the trade is sound only because the answer is checked. This
...
that tolerance, and not a plausible candidate awaiting a second opinion.
