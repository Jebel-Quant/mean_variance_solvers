...
That the plain exchange fails on general constraints is not news, and the repair
the literature offers says where the difficulty sits. Curtis, Han and
...
and it has to: no rule for choosing the next set can recover the bound-constrained
theorem when the subproblem on the chosen set may be singular. What is claimed here
is the mechanism and its price. The rank condition is the one already governing
Proposition~\ref{prop:sub}, it is a property of the guess and not of the data, and
Section~\ref{ssec:pdas} measures both how invisible it is on random instances and
how quickly a repeated column makes it certain.
