...
Since $G \succ 0$ the objective is strictly convex and coercive, so \eqref{eq:qp2} has exactly one solution whenever $\Omega \neq \emptyset$; see~\cite[Ch.~16]{nocedal2006}. What the method needs beyond that is the converse of the usual necessary conditions, and we prove it because every certificate in this note rests on it.
