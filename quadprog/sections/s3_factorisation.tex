...
and one the companion implementation paper~\cite{schmelzer2026quadprog} answers by
comparing complete active-set trajectories rather than only minimisers.
\end{remark}
