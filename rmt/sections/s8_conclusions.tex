...
the $p$ balance constraints $Bw=c$ being eliminated by a $p \times p$ Schur
complement.
...
more than $20\times$ cold on a real S\&P~500 minimum-variance solve.
The returned weights satisfy the KKT optimality conditions to solver accuracy,
and Woodbury reproduces the KKT-Cholesky solution to machine precision. The same
Woodbury kernel powers
